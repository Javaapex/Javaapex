"""
AI Service - OpenAI-compatible LLM Integration for Java Migration
...
class FordLLMAPI:
    """OpenAI-compatible API client (legacy class name kept)."""
    
    def __init__(self):
        from services.fordllm_auth_service import fordllm_auth
        self._auth = fordllm_auth
        self.base_url = os.getenv("LLM_BASE_URL", os.getenv("OPENAI_BASE_URL", "https://api.openai.com/v1"))
        self.model = os.getenv("LLM_MODEL", os.getenv("OPENAI_MODEL", "gpt-4.1-mini"))
        self.sub_model = os.getenv("LLM_SUB_MODEL", "")
    ...
    async def generate_text(
        ...
        try:
            ...
            return {
                ...
                "model": f"openai_compatible/{self.sub_model or self.model}",
                "status_code": 200,
            }
...
class AIAnalysisService:
    ...
    def __init__(self):
        ...
        self.models = {
            "business_logic": os.getenv("LLM_MODEL", os.getenv("OPENAI_MODEL", "gpt-4.1-mini")),
            "code_quality": os.getenv("LLM_MODEL", os.getenv("OPENAI_MODEL", "gpt-4.1-mini")),
            "dependency_analysis": os.getenv("LLM_MODEL", os.getenv("OPENAI_MODEL", "gpt-4.1-mini")),
            "automated_fixes": os.getenv("LLM_MODEL", os.getenv("OPENAI_MODEL", "gpt-4.1-mini")),
            "general_analysis": os.getenv("LLM_MODEL", os.getenv("OPENAI_MODEL", "gpt-4.1-mini"))
        }
        
        # Check FordLLM availability
        self.available_models = {}
        fordllm_available = self.hf_api.check_model_availability("openai_compatible")
