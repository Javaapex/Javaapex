    ...
    async def convert_build_file_with_llm(self, build_content: str, conversion_type: str, detected_build_tool: Optional[str] = None) -> str:
        ...
        if conversion_type == "maven_to_gradle":
            prompt = (
                ...
                "4. SCOPE MAPPING: compile → implementation, test → testImplementation, provided → compileOnly, runtime → runtimeOnly\n"
            ...
            prompt = (
                ...
                "4. SCOPE MAPPING: implementation → compile, testImplementation → test, compileOnly → provided, runtimeOnly → runtime\n"
        ...
        try:
            ...
            completion = await loop.run_in_executor(
                ...
                lambda: client.chat.completions.create(
                    ...
                    max_tokens=1500,
                    temperature=0.1,
                    extra_body={"models": [fordllm_sub_model]},
                ),
            )
